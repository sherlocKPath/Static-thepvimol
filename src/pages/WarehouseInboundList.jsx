        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden">
            ...
            <table className="w-full text-left border-collapse">
              <thead className="bg-[#f1f3f5] border-b border-slate-300 font-bold">
                <tr className="divide-x divide-slate-200 text-slate-600">
                  ...
                  <th className="px-6 py-4 text-xs text-center uppercase tracking-wider">
                    จำนวนตามรหัสสินค้า
                  </th>
                  <th className="px-6 py-4 text-center text-xs tracking-wider">
                    จำนวนตาม Job No.
                  </th>
                  <th className="px-6 py-4 text-center text-xs uppercase tracking-wider font-black text-indigo-700">
                    รวมยอด (กล่อง)
                  </th>
                  <th className="px-6 py-4 text-center text-xs uppercase tracking-wider font-black text-blue-700 bg-blue-50/30">
                    รวมจำนวนชิ้น
                  </th>
                  <th className="px-6 py-4 text-center text-xs tracking-wider w-32">
                    Tool
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-200 text-sm font-bold">
                {inboundSummary.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-center font-black text-blue-800 bg-blue-50/50">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-center space-x-3 text-slate-400">
                        <button
                          ...
                          className="p-2 bg-slate-50 hover:bg-slate-600 text-slate-500 hover:text-white rounded-lg transition-all border border-slate-200 active:scale-90"
                        >
                          <Search size={14} />
                        </button>
                        <button className="p-2 bg-blue-50 hover:bg-blue-600 text-blue-500 hover:text-white rounded-lg transition-all border border-blue-200 active:scale-90">
                          <Edit size={14} />
                        </button>
          ...
          <div className="px-8 py-5 bg-slate-50 border-t border-slate-200 flex items-center justify-between font-bold">
            ...
            <div className="flex items-center space-x-1">
              ...
              <button className="w-8 h-8 flex items-center justify-center text-xs font-black bg-[#004a99] text-white rounded-lg shadow-lg shadow-blue-200 transition-transform active:scale-95">
                1
              </button>
              <button className="p-2 border border-slate-300 rounded bg-white hover:bg-slate-50 shadow-sm transition-all">
