...
const Login = ({ onLoginSuccess }) => {
  // ตั้งค่า Default ไว้ที่นี่เพื่อให้ช่อง Input มีข้อมูลทันทีที่เปิดหน้าจอ
  const [email, setEmail] = useState("admin@thepvimol.com");
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setIsLoading(true);
    // จำลองการตรวจสอบสิทธิ์ (Mock Auth)
    setTimeout(() => {
      setIsLoading(false);
      setIsSuccess(true);
      setTimeout(() => {
  ...
  return (
    <div className="flex h-screen w-full bg-white overflow-hidden font-sans">
      {/* --- Left Side: New Brand Layout (คงเดิม) --- */}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="admin@thepvimol.com"
                ...
                >
                  {isLoading ? (
                    ...
                    <>
                      <LogIn size={24} /> <span>เข้าสู่ระบบ</span>
                    </>
                  )}
                </button>
              </form>
